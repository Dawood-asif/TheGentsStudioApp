...
export function getAchievements(customer = {}) {
  return [
    { id: 'first-visit', title: 'First Visit', unlocked: Number(customer.visits || 0) >= 1 },
    { id: 'elite-path', title: 'Elite Path', unlocked: Number(customer.points || 0) >= 1500 },
    { id: 'stamp-starter', title: 'Stamp Starter', unlocked: Number(customer.stamps || 0) >= 3 },
    { id: 'reward-hunter', title: 'Reward Hunter', unlocked: Number(customer.stamps || 0) >= 15 },
  ];
}